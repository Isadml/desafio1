...
public class ConexionEstatica {
    ...
    public static Profesor existeProfesor(String email) {
        ...
        try {
            ...
            {
                existe = new Profesor(Conj_Registros.getString("codProf"), Conj_Registros.getString("nombre"), Conj_Registros.getString("apellido"), Conj_Registros.getString("email"), Conj_Registros.getString("password"));
            }
        } catch (SQLException ex) {
    ...
    public static LinkedList obtenerProfesores() {
        ...
        try {
            ...
            while (Conj_Registros.next()) {
                p = new Profesor(Conj_Registros.getString("codProf"), Conj_Registros.getString("email"), Conj_Registros.getString("nombre"), Conj_Registros.getString("apellido"), Conj_Registros.getString("password"));
                usuariosBD.add(p);
            }
        } catch (SQLException ex) {
        }
    ...
    //----------------------------------------------------------
    public static void insertarProfesor(String email, String nombre, String apellido, String password, String codProf) throws SQLException {
        String Sentencia = "INSERT INTO profesores VALUES ('" + nombre + "'," + "'" + apellido + "','" + email + "'" + password + "', '" + codProf +  "')";
