    ...
    <body>
        ...
        <% LinkedList Lista_Horario = (LinkedList<Horario>) session.getAttribute("horario");
            ...
            for (int i = 0; i < Lista_Horario.size(); i++) {
                ...
                Reserva r = (Reserva) Lista_Horas_Reservadas.get(i);

        %>

        <form>
            <label for="cod_hora">Código reserva </label><input type="number" id="cod_hora" name="cod_hora" value="<%=h.getCod_Hora()%>" style="width: 50px">
