...
<html>
    ...
    <body>
        ...
        <form name="registro" action="../Controladores/controlador_Nuevo_Usuario.jsp" method="POST">
            ...
            <label for="nombre">Nombre: </label><input type="text" id="nombre" name="nombre" value=""></br></br>
            <label for="apellido">Apellido: </label><input type="text" id="nombre" name="apellido" value=""></br></br>
            <label for="password1">Password: </label><input type="password" id="password1" name="pass1" value=""></br></br>
            <label for="password2">Repetir password: </label><input type="password" id="password2" name="pass2" value=""></br></br>
